        ...
        success: function(response) {
            ...
            <div class="container" >
                <div class="row" >
                    ...
                    <div class="col">
                        <label>Nombre:</label>
                        <input type="text"   class="form-control"  value="${response[0].nombre}"  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"  required  id="nombre" 
                        title="La primer letra debe ser Mayúscula y no debe contener carácteres especiales (*{}+!¡¿?)"   name="nombre"  ><br>
                    </div>
                </div>
                <div class="row" >
                    <div class="col">
                        <label> Apellido Paterno: </label>
                        <input type="text" value="${response[0].apellido_paterno}" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"  required class="form-control"  id="apellidoP" 
                        title="La primer letra debe ser Mayúscula y no debe contener carácteres especiales (*{}+!¡¿?)" name="apellidoP" ><br>
                    </div>
                    <div class="col">
                        <label>Apellido Materno:</label>
                        <input type="text" value="${response[0].apellido_materno}"  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"  required  class="form-control"  id="apellidoM"
                        title="La primer letra debe ser Mayúscula y no debe contener carácteres especiales (*{}+!¡¿?)" name="apellidoM" ><br>
                    </div>
                </div>
                <div class="row">
                    <div class="col">
                        <label>Correo:</label>
                        <input type="text" value="${response[0].correo}"  required  id="correo" class="form-control" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}"
                         title="Utilce el formato adecuado : usuario@dominio.com , no utilizar carácteres especiales (['¿?!*+~])" name="correo" ><br>
                    </div>
                    <div class="col">
                        <label>Contraseña:</label>
                        <input type="password" value="${response[0].password}"  required   pattern="[A-Za-z0-9!?-]{8,12}"  title="Utiliza de 8 a 12 carácteres,numeros y letras(minúsculas o mayúsculas) " id="contra" class="form-control"   name="contra" ><br>
                    </div>
                </div>
                <div class="row">
                    <div class="col-6">
...
const insertUser = () => {
    ...
    <div class="container" >
        <div class="row" >
            <div class="col">
                <label>Nombre:</label>
                <input type="text"   class="form-control"  pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}"
                 required  id="nombre"    name="nombre" title="Para ser válido, la primer letra debe ser Mayúscula y no debe contener carácteres especiales (*{}+!¡¿?)"><br>
            </div>
        </div>
        <div class="row" >
            <div class="col">
                <label> Apellido paterno: </label>
                <input type="text"   required class="form-control" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" 
                 id="apellidoP" name="apellidoP" title="La primer letra debe ser Mayúscula y no debe contener carácteres especiales (*{}+!¡¿?)"><br>
            </div>
            <div class="col">
                <label>Apellido Materno:</label>
                <input type="text"   required  class="form-control" pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" id="apellidoM"
                title="La primer letra debe ser Mayúscula y no debe contener carácteres especiales (*{}+!¡¿?)" name="apellidoM" ><br>
            </div>
        </div>
        <div class="row">
            <div class="col">
                <label>Correo:</label>
                <input type="text"   required   pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}"
                title="Utilce el formato adecuado : usuario@dominio.com , no utilizar carácteres especiales (['¿?!*+~])"  id="correo" class="form-control"  name="correo" ><br>
            </div>
            <div class="col">
                <label>Contraseña:</label>
                <input type="text"  required   pattern="[A-Za-z0-9!?-]{8,12}"  title="Utiliza de 8 a 12 carácteres,numeros y letras(minúsculas o mayúsculas) " id="contra" class="form-control"   name="contra" ><br>
            </div>
        </div>
        <div class="row">
            <div class="col-6">
